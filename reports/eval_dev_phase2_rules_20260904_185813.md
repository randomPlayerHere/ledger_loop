# Eval — `dev_phase2_rules`

Generated 2026-09-04 18:58:13 · 520 transactions · 499 truth links

## Headline

| Metric | Value | Target |
|---|---|---|
| Auto-match rate | 0.638 | ≥ 0.80 |
| Precision (auto only) | 1.000 | ≥ 0.98 |
| Recall (all outcomes) | 0.711 | ≥ 0.93 |
| Abstention precision | 0.766 | ≥ 0.70 |
...
| Throughput (txns/min) | 6,902.2 | report |
...
TP 355 · FP 2 · FN 144 · precision 0.994 · recall 0.711 · F1 0.829
...
| HARD | 203 | 113 | 213 | 113 | 0 | 100 | 1.000 | 0.531 | 0.693 |
...
| PARTIAL | 104 | 28 | 104 | 28 | 0 | 76 | 1.000 | 0.269 | 0.424 |
